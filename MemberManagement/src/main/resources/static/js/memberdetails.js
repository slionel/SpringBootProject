        ...
        success:function (json) {
            ...
            $.getJSON("mc/getallbyname",{userName:username},function (data) {
                ...
                $("#submitbtn").click(function () {
                    ...
                    $.getJSON("mc/update",{password:password, id:id,sex:sex,tel:tel,username:username,email:email,invitecode:invitecode,registerdate:registerdate,address:address},function (update) {
                        if(update.rs == "true"){
                            alert("修改成功");
